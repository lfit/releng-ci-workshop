...
Credentials nexus_credentials = (Credentials) new UsernamePasswordCredentialsImpl(
...
Thread.start {
    ...
    GlobalConfigFiles config_files_store = Jenkins.getInstance().getExtensionList(GlobalConfigFiles.class).get(GlobalConfigFiles.class);

		ServerCredentialMapping server_credentials = new ServerCredentialMapping("logs", "nexus-credentials");
		List<ServerCredentialMapping> server_mapping = new ArrayList<ServerCredentialMapping>();
